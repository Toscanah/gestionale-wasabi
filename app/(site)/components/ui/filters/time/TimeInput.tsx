...
export default function TimeInput({ label, value, onChange }: TimeInputProps) {
  ...
  return (
    <div className="flex flex-col items-start gap-2">
      ...
      <div className="flex items-center gap-1 bg-muted/30 px-2 py-1.5 rounded-lg border border-border">
        <Input
          id={label + "-h"}
          type="text"
          inputMode="numeric"
          ...
          className="w-12 text-center font-medium bg-transparent border-none focus-visible:ring-0 focus-visible:outline-none"
          placeholder="hh"
        />
